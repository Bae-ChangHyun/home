...
<div class="side">
  ...
  <div class="write-btn-text">
        <a href="write_dev.php"><button name="write-btn">글쓰기</button></a>
  </div>
        ...
        <?php
            ...
            try {
                ...
                $row_num=$stmh->rowCount();
                  ...
                  try {
                      $sql2="select * from board_dev order by idx desc limit $start_num, $list";
                  ...
                  while ($board = $stmh2->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      try {
                          $sql3="select * from reply_dev where con_num='".$board['idx']."'";
      ...
      <tbody>
        <tr>
          ...
          <td width="500" class="wh3">
            ...
            if($userid=="admin"){
              ?>
              <th width="80" class="wh3"><a href="delete_dev.php?idx=<?php echo $board['idx']; ?>">삭제</a></th> <?php
            } else { }?>
        </tr>
      </tbody>
      <?php
...
<a href='ck_read_dev.php?idx=<?php echo $board["idx"];?>'><?php echo $title ; ?>---[<?php echo $rep_count; ?>]<?php echo $lockimg ; ?><?php
} else {?>

<a href='read_dev.php?idx=<?php echo $board["idx"]; ?>'><?php echo $title; ?> ---[<?php echo $rep_count; ?>] <?php } ?></a></td>
<td width="120" class="wh3"><?php echo $board['name']?></td>
<td width="100" class="wh3"><?php echo $board['date']?></td>
<td width="100" class="wh3"><?php echo $board['hit']; ?></td>
<?php
